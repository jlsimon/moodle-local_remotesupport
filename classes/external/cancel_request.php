 ...
 * session_manager::cancel_request() itself, same as the PHP-page fallback.
 *
...
class cancel_request extends external_api {
    ...
    public static function execute($sessionid): array {
        ...
        $updated = session_manager::cancel_request($session->id, (int) $USER->id);
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            'status' => new external_value(PARAM_ALPHA, 'The session status after cancelling'),
        ]);
    }
}
