 ...
 *
 * Deliberately has no objecttable: the point of this event is to record
 * attempts that may not correspond to a session the caller was entitled to
 * even know about (e.g. a guessed id or an expired token).
 *
